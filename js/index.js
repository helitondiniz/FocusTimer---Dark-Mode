...
const bodyDarkColor = document.querySelector('body')

/* - buttons-box-shadow/colors/sounds -  - */
...
const forestColor = document.querySelector('#forest-color')
...
function bodyColorReset() {
  ...
  buttonMoon.style.background = 'FF7644'
}
...
function bodyColor() {
  ...
  buttonMoon.style.boxShadow = ' 0px 0px 6px #FFFFFF, -0px -0px 6px #ffffff'
  buttonMoon.style.background = 'transparent'

  buttonSun.style.boxShadow = ' 0px 0px 6px #FFFFFF, -0px -0px 6px #ffffff'
  buttonSun.style.background = 'transparent'
}

function bodyColorDark() {
  iconsShadow1.style.fill = 'white'
  buttonForest.style.boxShadow = '  0px 0px 6px #FFFFFF, -0px -0px 6px #ffffff'
...
document.getElementById('forest').addEventListener('click', function () {
  ...
  volForest.oninput = function () {
    soundForest.volume = volForest.value / 100
  }

  inputVol.style.backgroundColor = 'white'

  inputVol.style.webkitSliderThumb = 'background-color: red'
  inputVol.style.webkitSliderThumb = 'border: none'
})
...
document.getElementById('bakery').addEventListener('click', function () {
  ...
  volBakery.oninput = function () {
    soundBakery.volume = volBakery.value / 100
  }
})
...
document.getElementById('fireplace').addEventListener('click', function () {
  ...
  volFireplace.oninput = function () {
    soundFireplace.volume = volFireplace.value / 100
  }
})
